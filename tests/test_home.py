...
class HomeTest(HomePage):
    ...
    def test_home_page(self):
        ...
        # assert logo
        self.assert_element_present(HomePage.logo_icon)
        ...
        # Scroll to bottom, assert Copyright text
        self.scroll_to_bottom()
        self.assert_text("Copyright © 2020 Automation Bro", HomePage.site_footer)
